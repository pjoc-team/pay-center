...
var cluster = "00"
var g = generator.New(&cluster, 100)

func Request(domain string) (*pb.PayResponse) {
	request := &pb.PayRequest{}
	request.ChannelId = "isp"
	request.Method = pb.Method_name[int32(pb.Method_WEB)]
	request.ProductName = "apple"
	request.ProductDescribe = "apple"
	request.UserIp = "127.0.0.1"
	request.ExtJson = "{\"service_type\":\"direct_pay\"}"
